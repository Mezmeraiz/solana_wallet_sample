...
class OperationTrustSet extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set limitAmount(CurrencyAmount v) { $_setField(1, v); }
  @$pb.TagNumber(1)
...
class SigningInput extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(7)
  set opTrustSet(OperationTrustSet v) { $_setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set opPayment(OperationPayment v) { $_setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set opNftokenBurn(OperationNFTokenBurn v) { $_setField(9, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(10)
  set opNftokenCreateOffer(OperationNFTokenCreateOffer v) { $_setField(10, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(11)
  set opNftokenAcceptOffer(OperationNFTokenAcceptOffer v) { $_setField(11, v); }
  @$pb.TagNumber(11)
  ...
  @$pb.TagNumber(12)
  set opNftokenCancelOffer(OperationNFTokenCancelOffer v) { $_setField(12, v); }
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(16)
  set opEscrowCreate(OperationEscrowCreate v) { $_setField(16, v); }
  @$pb.TagNumber(16)
  ...
  @$pb.TagNumber(17)
  set opEscrowCancel(OperationEscrowCancel v) { $_setField(17, v); }
  @$pb.TagNumber(17)
  ...
  @$pb.TagNumber(18)
  set opEscrowFinish(OperationEscrowFinish v) { $_setField(18, v); }
  @$pb.TagNumber(18)
