...
class CustomCallIndices extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(4)
  void clearModuleIndex() => $_clearField(4);
  ...
  @$pb.TagNumber(5)
  void clearMethodIndex() => $_clearField(5);
}
...
class CallIndices extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set custom(CustomCallIndices v) { $_setField(1, v); }
  @$pb.TagNumber(1)
...
class Balance_Transfer extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(4)
  set callIndices(CallIndices v) { $_setField(4, v); }
  @$pb.TagNumber(4)
...
class Balance_BatchTransfer extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set callIndices(CallIndices v) { $_setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  $pb.PbList<Balance_Transfer> get transfers => $_getList(1);
}
...
class Balance_AssetTransfer extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(5)
  void clearFeeAssetId() => $_clearField(5);
}
...
class Balance_BatchAssetTransfer extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  void clearFeeAssetId() => $_clearField(2);

  @$pb.TagNumber(3)
  $pb.PbList<Balance_AssetTransfer> get transfers => $_getList(2);
}
...
class Balance extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set transfer(Balance_Transfer v) { $_setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set batchTransfer(Balance_BatchTransfer v) { $_setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasBatchTransfer() => $_has(1);
  @$pb.TagNumber(2)
  void clearBatchTransfer() => $_clearField(2);
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set assetTransfer(Balance_AssetTransfer v) { $_setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasAssetTransfer() => $_has(2);
  @$pb.TagNumber(3)
  void clearAssetTransfer() => $_clearField(3);
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set batchAssetTransfer(Balance_BatchAssetTransfer v) { $_setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasBatchAssetTransfer() => $_has(3);
  @$pb.TagNumber(4)
  void clearBatchAssetTransfer() => $_clearField(4);
  @$pb.TagNumber(4)
...
class Staking_Bond extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  set rewardDestination(RewardDestination v) { $_setField(3, v); }
  @$pb.TagNumber(3)
...
class Staking_BondAndNominate extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(5)
  set callIndices(CallIndices v) { $_setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasCallIndices() => $_has(4);
  @$pb.TagNumber(5)
  void clearCallIndices() => $_clearField(5);
  @$pb.TagNumber(5)
...
class Staking_BondExtra extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  set callIndices(CallIndices v) { $_setField(2, v); }
  @$pb.TagNumber(2)
...
class Staking extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set bond(Staking_Bond v) { $_setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set bondAndNominate(Staking_BondAndNominate v) { $_setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set bondExtra(Staking_BondExtra v) { $_setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set unbond(Staking_Unbond v) { $_setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set withdrawUnbonded(Staking_WithdrawUnbonded v) { $_setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set nominate(Staking_Nominate v) { $_setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set chill(Staking_Chill v) { $_setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set chillAndUnbond(Staking_ChillAndUnbond v) { $_setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set rebond(Staking_Rebond v) { $_setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasRebond() => $_has(8);
  @$pb.TagNumber(9)
  void clearRebond() => $_clearField(9);
  @$pb.TagNumber(9)
...
class Identity_AddAuthorization_AuthData extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set asset(Identity_AddAuthorization_Data v) { $_setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set extrinsic(Identity_AddAuthorization_Data v) { $_setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set portfolio(Identity_AddAuthorization_Data v) { $_setField(3, v); }
  @$pb.TagNumber(3)
...
class Identity_AddAuthorization extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  set data(Identity_AddAuthorization_AuthData v) { $_setField(3, v); }
  @$pb.TagNumber(3)
...
class Identity extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set joinIdentityAsKey(Identity_JoinIdentityAsKey v) { $_setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set addAuthorization(Identity_AddAuthorization v) { $_setField(2, v); }
  @$pb.TagNumber(2)
...
class PolymeshCall extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  set identityCall(Identity v) { $_setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasIdentityCall() => $_has(0);
  @$pb.TagNumber(2)
  void clearIdentityCall() => $_clearField(2);
  @$pb.TagNumber(2)
...
class SigningInput extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(10)
  void clearMultiAddress() => $_clearField(10);

  @$pb.TagNumber(11)
  Balance get balanceCall => $_getN(10);
  @$pb.TagNumber(11)
  set balanceCall(Balance v) { $_setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasBalanceCall() => $_has(10);
  @$pb.TagNumber(11)
  void clearBalanceCall() => $_clearField(11);
  @$pb.TagNumber(11)
  ...
  @$pb.TagNumber(12)
  set stakingCall(Staking v) { $_setField(12, v); }
  @$pb.TagNumber(12)
  $core.bool hasStakingCall() => $_has(11);
  @$pb.TagNumber(12)
  void clearStakingCall() => $_clearField(12);
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(13)
  set polymeshCall(PolymeshCall v) { $_setField(13, v); }
  @$pb.TagNumber(13)
  $core.bool hasPolymeshCall() => $_has(12);
  @$pb.TagNumber(13)
  void clearPolymeshCall() => $_clearField(13);
  @$pb.TagNumber(13)
...
class SigningOutput extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  set error($0.SigningError v) { $_setField(2, v); }
  @$pb.TagNumber(2)
