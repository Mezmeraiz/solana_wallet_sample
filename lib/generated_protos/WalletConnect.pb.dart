...
class ParseRequestInput extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set protocol(Protocol v) { $_setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set method(Method v) { $_setField(2, v); }
  @$pb.TagNumber(2)
...
class ParseRequestOutput extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  set binance($6.SigningInput v) { $_setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set solana($7.SigningInput v) { $_setField(4, v); }
  @$pb.TagNumber(4)
