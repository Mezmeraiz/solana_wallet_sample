...
class RawMessage_MessageLegacy extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set header(RawMessage_MessageHeader v) { $_setField(1, v); }
  @$pb.TagNumber(1)
...
class RawMessage_MessageV0 extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(5)
  $pb.PbList<RawMessage_MessageAddressTableLookup> get addressTableLookups => $_getList(4);
}
...
class RawMessage extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  set legacy(RawMessage_MessageLegacy v) { $_setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set v0(RawMessage_MessageV0 v) { $_setField(3, v); }
  @$pb.TagNumber(3)
...
class DecodingTransactionOutput extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set transaction(RawMessage v) { $_setField(1, v); }
  @$pb.TagNumber(1)
...
class SigningInput extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(4)
  set transferTransaction(Transfer v) { $_setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set delegateStakeTransaction(DelegateStake v) { $_setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set deactivateStakeTransaction(DeactivateStake v) { $_setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set deactivateAllStakeTransaction(DeactivateAllStake v) { $_setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set withdrawTransaction(WithdrawStake v) { $_setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set withdrawAllTransaction(WithdrawAllStake v) { $_setField(9, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(10)
  set createTokenAccountTransaction(CreateTokenAccount v) { $_setField(10, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(11)
  set tokenTransferTransaction(TokenTransfer v) { $_setField(11, v); }
  @$pb.TagNumber(11)
  ...
  @$pb.TagNumber(12)
  set createAndTransferTokenTransaction(CreateAndTransferToken v) { $_setField(12, v); }
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(13)
  set createNonceAccount(CreateNonceAccount v) { $_setField(13, v); }
  @$pb.TagNumber(13)
  ...
  @$pb.TagNumber(16)
  set withdrawNonceAccount(WithdrawNonceAccount v) { $_setField(16, v); }
  @$pb.TagNumber(16)
  ...
  @$pb.TagNumber(19)
  set advanceNonceAccount(AdvanceNonceAccount v) { $_setField(19, v); }
  @$pb.TagNumber(19)
  ...
  @$pb.TagNumber(20)
  set rawMessage(RawMessage v) { $_setField(20, v); }
  @$pb.TagNumber(20)
  ...
  @$pb.TagNumber(21)
  set txEncoding(Encoding v) { $_setField(21, v); }
  @$pb.TagNumber(21)
  ...
  @$pb.TagNumber(22)
  set priorityFeePrice(PriorityFeePrice v) { $_setField(22, v); }
  @$pb.TagNumber(22)
  ...
  @$pb.TagNumber(23)
  set priorityFeeLimit(PriorityFeeLimit v) { $_setField(23, v); }
  @$pb.TagNumber(23)
...
class PreSigningOutput extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  set error($0.SigningError v) { $_setField(3, v); }
  @$pb.TagNumber(3)
