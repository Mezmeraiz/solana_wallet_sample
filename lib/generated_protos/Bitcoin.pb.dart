...
class TransactionInput extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set previousOutput(OutPoint v) { $_setField(1, v); }
  @$pb.TagNumber(1)
...
class UnspentTransaction extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(4)
  set variant(TransactionVariant v) { $_setField(4, v); }
  @$pb.TagNumber(4)
...
class SigningInput extends $pb.GeneratedMessage {
  factory SigningInput({
    ...
    $pb.PbMap<$core.String, $core.List<$core.int>>? scripts,
  ...
  @$pb.TagNumber(11)
  set plan(TransactionPlan v) { $_setField(11, v); }
  @$pb.TagNumber(11)
  ...
  @$pb.TagNumber(21)
  set signingV2($1.SigningInput v) { $_setField(21, v); }
  @$pb.TagNumber(21)
  ...
  @$pb.TagNumber(26)
  set outputOpReturnIndex(OutputIndex v) { $_setField(26, v); }
  @$pb.TagNumber(26)
...
class TransactionPlan extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(7)
  set error($0.SigningError v) { $_setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(12)
  set planningResultV2($1.TransactionPlan v) { $_setField(12, v); }
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(14)
  set outputOpReturnIndex(OutputIndex v) { $_setField(14, v); }
  @$pb.TagNumber(14)
...
class SigningOutput extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(4)
  set error($0.SigningError v) { $_setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(7)
  set signingResultV2($1.SigningOutput v) { $_setField(7, v); }
  @$pb.TagNumber(7)
