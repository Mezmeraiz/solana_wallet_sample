...
class Transfer extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set walletVersion(WalletVersion v) { $_setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(6)
  void clearBounceable() => $_clearField(6);

  /// Jetton transfer payload.
  @$pb.TagNumber(7)
  JettonTransfer get jettonTransfer => $_getN(6);
  @$pb.TagNumber(7)
  set jettonTransfer(JettonTransfer v) { $_setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set customPayload(CustomPayload v) { $_setField(8, v); }
  @$pb.TagNumber(8)
...
class CustomPayload extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  void clearStateInit() => $_clearField(1);
