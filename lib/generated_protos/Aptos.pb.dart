...
class TokenTransferMessage extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  set function(StructTag v) { $_setField(3, v); }
  @$pb.TagNumber(3)
...
class ManagedTokensRegisterMessage extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set function(StructTag v) { $_setField(1, v); }
  @$pb.TagNumber(1)
...
class LiquidStaking extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  set stake(TortugaStake v) { $_setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set unstake(TortugaUnstake v) { $_setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set claim(TortugaClaim v) { $_setField(4, v); }
  @$pb.TagNumber(4)
...
class NftMessage extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set offerNft(OfferNftMessage v) { $_setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set cancelOfferNft(CancelOfferNftMessage v) { $_setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set claimNft(ClaimNftMessage v) { $_setField(3, v); }
  @$pb.TagNumber(3)
...
class SigningInput extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(9)
  set transfer(TransferMessage v) { $_setField(9, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(10)
  set tokenTransfer(TokenTransferMessage v) { $_setField(10, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(11)
  set createAccount(CreateAccountMessage v) { $_setField(11, v); }
  @$pb.TagNumber(11)
  ...
  @$pb.TagNumber(12)
  set nftMessage(NftMessage v) { $_setField(12, v); }
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(13)
  set registerToken(ManagedTokensRegisterMessage v) { $_setField(13, v); }
  @$pb.TagNumber(13)
  ...
  @$pb.TagNumber(14)
  set liquidStakingMessage(LiquidStaking v) { $_setField(14, v); }
  @$pb.TagNumber(14)
  ...
  @$pb.TagNumber(15)
  set tokenTransferCoins(TokenTransferCoinsMessage v) { $_setField(15, v); }
  @$pb.TagNumber(15)
...
class SigningOutput extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  set authenticator(TransactionAuthenticator v) { $_setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(5)
  set error($0.SigningError v) { $_setField(5, v); }
  @$pb.TagNumber(5)
