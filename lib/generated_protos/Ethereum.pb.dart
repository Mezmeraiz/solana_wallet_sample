...
class Transaction_Batch extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  $pb.PbList<Transaction_Batch_BatchedCall> get calls => $_getList(0);
}
...
class Transaction extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set transfer(Transaction_Transfer v) { $_setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set erc20Transfer(Transaction_ERC20Transfer v) { $_setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set erc20Approve(Transaction_ERC20Approve v) { $_setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set erc721Transfer(Transaction_ERC721Transfer v) { $_setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set erc1155Transfer(Transaction_ERC1155Transfer v) { $_setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set contractGeneric(Transaction_ContractGeneric v) { $_setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set batch(Transaction_Batch v) { $_setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasBatch() => $_has(6);
  @$pb.TagNumber(7)
  void clearBatch() => $_clearField(7);
  @$pb.TagNumber(7)
...
class SigningInput extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  set txMode(TransactionMode v) { $_setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(10)
  set transaction(Transaction v) { $_setField(10, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(11)
  set userOperation(UserOperation v) { $_setField(11, v); }
  @$pb.TagNumber(11)
...
class MessageSigningInput extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  set chainId(MaybeChainId v) { $_setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set messageType(MessageType v) { $_setField(4, v); }
  @$pb.TagNumber(4)
