...
class Pay extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(4)
  set gas(ObjectRef v) { $_setField(4, v); }
  @$pb.TagNumber(4)
...
class RequestWithdrawStake extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set stakedSui(ObjectRef v) { $_setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set gas(ObjectRef v) { $_setField(2, v); }
  @$pb.TagNumber(2)
...
class TransferObject extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set object(ObjectRef v) { $_setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(3)
  set gas(ObjectRef v) { $_setField(3, v); }
  @$pb.TagNumber(3)
...
class SigningInput extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  set signDirectMessage(SignDirect v) { $_setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(5)
  set paySui(PaySui v) { $_setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set payAllSui(PayAllSui v) { $_setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set requestAddStake(RequestAddStake v) { $_setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set requestWithdrawStake(RequestWithdrawStake v) { $_setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set transferObject(TransferObject v) { $_setField(9, v); }
  @$pb.TagNumber(9)
