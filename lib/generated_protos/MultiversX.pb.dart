...
class GenericAction extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set accounts(Accounts v) { $_setField(1, v); }
  @$pb.TagNumber(1)
...
class SigningInput extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(5)
  set genericAction(GenericAction v) { $_setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set egldTransfer(EGLDTransfer v) { $_setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set esdtTransfer(ESDTTransfer v) { $_setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set esdtnftTransfer(ESDTNFTTransfer v) { $_setField(8, v); }
  @$pb.TagNumber(8)
