...
class Transfer extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(4)
  set tokenAmount(TokenBundle v) { $_setField(4, v); }
  @$pb.TagNumber(4)
...
class TransactionPlan extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(9)
  set error($0.SigningError v) { $_setField(9, v); }
  @$pb.TagNumber(9)
...
class SigningInput extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  set transferMessage(Transfer v) { $_setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(5)
  set plan(TransactionPlan v) { $_setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set registerStakingKey(RegisterStakingKey v) { $_setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set delegate(Delegate v) { $_setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set withdraw(Withdraw v) { $_setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set deregisterStakingKey(DeregisterStakingKey v) { $_setField(9, v); }
  @$pb.TagNumber(9)
